                ...
                <div class="card-white p-6 rounded-3xl border border-slate-200/80 shadow-sm space-y-4 flex flex-col justify-between hover:border-indigo-300 transition">
                    ...
                    <div class="pt-4 border-t border-slate-100 flex items-center justify-between space-x-2">
                        <a href="{{ route('admin.roles.permissions', $role->id) }}" 
                           class="flex-1 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl text-xs font-extrabold transition inline-flex items-center justify-center space-x-1.5 border border-indigo-200/80">
                            <i data-lucide="shield-check" class="w-3.5 h-3.5 text-indigo-600"></i>
                            <span>Configure Menu Permissions</span>
                        </a>
