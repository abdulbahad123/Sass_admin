        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-3">
                    ...
                    <ul class="space-y-2 text-xs">
                        <li><a href="{{ route('agency.privacy') }}" class="hover:text-white transition">Privacy Policy</a></li>
                        <li><a href="{{ route('agency.terms') }}" class="hover:text-white transition">Terms & Conditions</a></li>
                        <li><a href="{{ route('agency.cookies') }}" class="hover:text-white transition">Cookie Policy</a></li>
                    </ul>
                </div>
