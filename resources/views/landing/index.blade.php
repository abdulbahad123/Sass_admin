    ...
    <section id="hero" class="relative pt-10 pb-12 lg:pt-14 lg:pb-16 overflow-hidden bg-gradient-to-b from-orange-50/60 via-amber-50/20 to-transparent reveal">
        <div class="max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <!-- Right Hero Image Graphic (Task 1: Increased size without overlapping left content, 20px gap) -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5">
                    <div class="bg-gradient-to-br from-slate-900 via-orange-950/40 to-slate-900 text-white rounded-3xl p-7 sm:p-8 shadow-2xl border border-slate-800">
